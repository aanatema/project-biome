			...
			<CardContent>
				<Accordion
					...
					<AccordionItem value='item-1 '>
						...
						<AccordionContent className='flex flex-col gap-4 text-balance'>
							<p>
								...
								project-biome.fr, is published by : Romane
								Boireau, residing at 3 Bd de Stalingrad, 44000
								Nantes, of French nationality (France).
							</p>
						</AccordionContent>
					</AccordionItem>
					...
					<AccordionItem value='item-3'>
						...
						<AccordionContent className='flex flex-col gap-4 text-balance'>
							<p>
								The Site's Publication Director is Romane
								Boireau.
							</p>
						</AccordionContent>
					</AccordionItem>
					...
					<AccordionItem value='item-5'>
						...
						<AccordionContent className='flex flex-col gap-4 text-balance'>
							<p>
								The processing of your personal data is governed
								by our Privacy Charter, available from the
								"Personal Data Protection Charter" section, in
